...
def load_data(type, task):
    ...
    path = os.path.join(base_path, task + '.json')

    # Important:
    # some JSON files contain UTF-8 characters that fail under the
    # default Windows encoding (often cp1252). We force UTF-8 here.
