...
NEG_MATRIX = H3_TABLES_DIR / "palier2a_negative_original_delta_matrix.csv"
H3_MATRIX = H3_TABLES_DIR / "palier2a_h3_delta_matrix.csv"
H3_VS_NEG_MATRIX = H3_TABLES_DIR / "palier2a_h3_minus_negative_original_matrix.csv"
