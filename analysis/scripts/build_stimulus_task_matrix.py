...
PRIMARY_INPUT = STIMULUS_TASK_DIR / "aggregated_by_strata.csv"
SECONDARY_INPUT = SECONDARY_DIR / "aggregated_secondary_metrics_numeric.csv"

PRIMARY_LONG = STIMULUS_TASK_DIR / "stimulus_task_long.csv"
PRIMARY_DELTA_MATRIX = STIMULUS_TASK_DIR / "stimulus_task_delta_matrix.csv"
